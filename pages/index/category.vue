...
<script setup>
  ...
  function goToList(subject) {
    vk.navigateTo(`/pages/index/list?grade=${currentGrade.value}&subject=${subject.key}&title=${encodeURIComponent(currentGrade.value.replace('grade','')+'年级·'+subject.label)}`)
  }
